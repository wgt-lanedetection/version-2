...
class Lines():
    def __init__(self):
        ...
        self.look_ahead = 10       #default 10
        self.remove_pixels = 90   #default 90
        # enlarge output image
        self.enlarge = 2.5        # default 2.5
    ...
    def binary_extraction(self,image, ksize=3):
        # undistort first
        image = undistort1(image) #---

        color_bin = self.color_thresh(image,thresh=(90, 150))   #default 90,150           # initial values 110, 255
    ...
    def project_on_road_debug(self, image_input):
        ...
        if self.detected_first & self.detected:
            ...
            if self.offset< 0:
                ...
                img_text2 = "distance to center: " + str(round((self.offset),2)) 
            else:
...
lines = Lines()
lines.look_ahead = 7 #default 2
lines.remove_pixels = 10
lines.enlarge = 2.0
